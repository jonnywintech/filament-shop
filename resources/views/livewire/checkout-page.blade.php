                    ...
                    <div class="mb-6">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    border-red-500
                                    @enderror"
                                    id="first_name" type="text" wire:model="first_name">
                                </input>
                                @error('first_name')
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    @error('last_name')
                                     border-red-500
                                    @enderror"
                                    id="last_name" type="text" wire:model="last_name">
                                </input>
                                @error('last_name')
                                    <div class="text-red-500 text-sm"> {{ $message }}</div>
                                @enderror
                        ...
                        <div class="mt-4">
                            ...
                            <input
                                ...
                                border-red-500
                                @enderror"
                                id="address" type="text" wire:model="address">
                            </input>
                            @error('address')
                                <div class="text-red-500 text-sm"> {{ $message }}</div>
                            @enderror
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    border-red-500
                                    @enderror"
                                    id="zip" type="text" wire:model="zip">
                                </input>
                                @error('zip')
                                    <div class="text-red-500 text-sm"> {{ $message }}</div>
                                @enderror
                            ...
                            <li class="py-3 sm:py-4" wire:key="{{ $cart_item['product_id'] }}">
                                <div class="flex items-center">
                                    ...
                                    <div
                                        ...
                                        {{ Number::currency($cart_item['unit_amount'], 'USD') }}
                                    </div>
                                </div>
                            </li>
                        @endforeach

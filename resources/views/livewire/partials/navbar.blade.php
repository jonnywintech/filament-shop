        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a wire:navigate class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="/" aria-label="Brand">Shopmania</a>
                <div class="md:hidden">
                    <button type="button"
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a wire:navigate
                            class="font-medium {{ request()->is('categories') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/categories">
                            Categories
                        </a>

                        <a wire:navigate
                            class="font-medium {{ request()->is('products') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/products">
                            Products
                        </a>

                        <a wire:navigate
                            class="font-medium {{ request()->is('blog') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500' }} hover:text-gray-400 py-3 md:py-6 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            href="/blog">
                            Blog
                        </a>
                        ...
                        @auth
                            ...
                            x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false"
                                ...
                                <div x-show="open" x-transition:enter="transition duration-150"
                                    ...
                                    class="hs-dropdown-menu transition-[opacity,margin] duration-[0.1ms] md:duration-[150ms]
                                    md:w-48 hidden z-10 bg-white md:shadow-md rounded-lg p-2 dark:bg-gray-800 md:dark:border dark:border-gray-700 dark:divide-gray-700 before:absolute top-full md:border before:-top-5 before:start-0 before:w-full before:h-5">

            ...
            <div class="p-4 md:p-5 flex gap-x-4">
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2 dark:text-white">
                        ...
                        <div>{{ $order_details->address->first_name }} {{ $order_details->address->last_name }}</div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="grow">
                    ...
                    <div class="mt-1 flex items-center gap-x-2">
                        <h3 class="text-xl font-medium text-gray-800 dark:text-gray-200">
                            {{ $order_details->address->created_at->format('Y-m-d') }}
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <div class="md:w-3/4">
                                ...
                                <td class="py-4">
                                    <div class="flex items-center">
                                        <img class="h-16 w-16 mr-4"
                                            src="{{ url('storage') . '/' . $item->product()->first()->images[0] }}"
                                            alt="Product image">
                                        <span class="font-semibold">{{ $item->product()->first()->name }}</span>
                                    </div>
                                </td>
            ...
            <div class="bg-white overflow-x-auto rounded-lg shadow-md p-6 mb-4">
                ...
                <div class="flex justify-between items-center">
                    <div>
                        <p>{{ $order_details->address->street_address }} {{ $order_details->address->city }}
                            {{ $order_details->address->state }}, {{ $order_details->address->zip_code }}</p>
                    </div>
                    <div>
                        <p class="font-semibold">Phone:</p>
                        <p>{{ $order_details->address->phone }}</p>
                    </div>
                </div>
            </div>
        ...
        <div class="md:w-1/4">
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <div class="flex justify-between mb-2">
                    <span>Subtotal</span>
                    <span>{{ Number::currency($order_details->grand_total) }}</span>
                </div>
                <div class="flex justify-between mb-2">
                    <span>Taxes</span>
                    <span>$0.0</span>
                ...
                <div class="flex justify-between mb-2">
                    ...
                    <span class="font-semibold">{{ Number::currency($order_details->grand_total) }}</span>
                </div>
